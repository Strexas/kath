 ...
 *
 * @description This enum provides a set of constants representing various file types and folder categories. Each constant maps
 * to a string value that corresponds to a specific file or folder type. This enumeration helps in managing and distinguishing
