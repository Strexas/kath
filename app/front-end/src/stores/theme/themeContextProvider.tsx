...
/**
 * Context providing theme mode and a function to toggle between light and dark modes.
 *
 * @interface ThemeContextProps
 * @property {string} mode - The current theme mode ('light' or 'dark').
 * @property {() => void} update - Function to toggle between light and dark modes.
 * @property {string[]} values - Array of possible theme modes.
 */
