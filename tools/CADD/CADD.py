...
if __name__ == "__main__":
    ...
    parser.add_argument("--start", type=int, help="Genomic start position (for a range of positions)")
    ...
    if args.position:
        ...
        print("Please provide either '--position' for single SNV or '--start' and '--end' for a range of positions.")
